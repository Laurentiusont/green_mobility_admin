                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex  flex-row flex-wrap ">
                                                <div class="mx-1 my-1">
                                                    ...
                                                    value="High income">
                                                    <label class="my-auto" style="font-weight:400" for="hic">High income</label>
                                                </div>
                                                <div class="mx-1 my-1">
                                                    <input  type="checkbox" id="lic" name="add-category[]"
                                                    value="Low income">
                                                    <label class="my-auto" style="font-weight:400" for="lic">Low income</label>
                                                </div>
                                                <div class="mx-1 my-1">
                                                    <input  type="checkbox" id="lmc" name="add-category[]"
                                                    value="Lower middle income">
                                                    <label class="my-auto" style="font-weight:400" for="lmc">Lower middle income</label>
                                                </div>
                                                <div class="mx-1 my-1">
                                                    <input  type="checkbox" id="lmy" name="add-category[]"
                                                    value="Low & middle income">
                                                    <label class="my-auto" style="font-weight:400" for="lmy">Low & middle income</label>
                                                </div>
                                                <div class="mx-1 my-1">
                                                    <input  type="checkbox" id="mic" name="add-category[]"
                                                    value="Middle income">
                                                    <label class="my-auto" style="font-weight:400" for="mic">Middle income</label>
                                                </div>
                                                <div class="mx-1 my-1">
                                                    <input class="ms-3 " type="checkbox" id="umc" name="add-category[]"
                                                    value="Upper middle income">
                                                    <label class="my-auto" style="font-weight:400" for="umc">Upper middle income</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
            ...
            $('#table-data').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        data: 'category',
                        render: function(data, type, row) {
                            var categories = JSON.parse('[' + data.replace(/&quot;/g, '"') + ']');

                            // Menghasilkan HTML yang di-render
                            var html = '<div class="text-wrap">' + categories.join(', ') + '</div>';
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return '<a role="button" class="edit-btn open-edit-dialog" style="text-decoration: none; margin-right: 10px;" data-guid="' +
                                ...
                                '<a href="/form/result/' + data['guid'] +
                                '" role="button" style="text-decoration: none; margin-right: 10px;"><i class="fa-solid fa-pen-to-square" style="font-size: 15px; color: yellow;"></i></a>' +

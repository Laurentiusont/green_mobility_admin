...
@section('content')
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <iframe
            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTxS3LnVcDNVbRBuE6qSon9ftiJ8mYo-RwzQxvQjtL6qsK0ah1R_l80HGwxBYTv4OzkIVl2AD_7JUB7/pubhtml?widget=true&amp;headers=false"
            style="position: fixed; top: 100; left: 100; width: 100%; height: 80%; border: none;"></iframe>
    </div>
@endsection
